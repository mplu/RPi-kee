...
void* threadMotorXSurvey (void* arg)
{
    ...
    while(1) /* Boucle infinie */
    {
		...
		{
			StepperTurnClockwise(MotorX_LR, Params.XMotorCommand.Speed, Params.XMotorCommand.Unused, &sem_XMotorEmergencyStop);
		}else if (Params.XMotorCommand.Unused < 0)
		{
			StepperTurnCounterClockwise(MotorX_LR, Params.XMotorCommand.Speed, 0-Params.XMotorCommand.Unused, &sem_XMotorEmergencyStop);
		}else
		{
